...
The GenAICHI Workshop will take place from 09:00 to 18:00 Japan Standard Time (GMT+9), 27 April, 2025. Paper presentation sessions are listed below. Papers in these sessions have 5-minute presentations with a 10-minute discussion at the end of the session.
Papers listed under "Title+Authors (without formal presentation)," are accepted in the workshop but without an oral presentation.

Please submit finalised paper PDFs on [CMT](https://cmt3.research.microsoft.com/genaichi2025) using the camera ready form and following our [camera-ready instructions]({% link camera-ready.md %}).

## Welcome and Introductions (09:00--09:30) 

Welcome and Introductions from the organisers.
...
1. Pauline Leininger (University of Television and Film Munich), Christoph Johannes Weber (University of Television and Film Munich): _Democratizing Creative Participation and Collaboration in Virtual Film Productions with AI Visualizations_ [[pdf]](https://github.com/GenerativeAIandHCI/GenerativeAIandHCI.github.io/blob/main/papers/2025/31%20Democratizing_Creative_Participation_in_VP___CHI25%20.pdf)
...
Morning tea break. Light refreshments will be provided at the venue.

## Session 3: Creativity - Visual (11:10--11:40)

1. DaEun Choi (KAIST), Kihoon Son (KAIST), HyunJoon Jung (Adobe), Juho Kim (KAIST): _Expandora: Broadening Design Exploration with Text-to-Image Model_ [[pdf]](https://github.com/GenerativeAIandHCI/GenerativeAIandHCI.github.io/blob/main/papers/2025/41%20GENAICHI2025_Workshop__Expandora.pdf)
2. Yenkai Huang (Dartmouth College), Zheng Ning (University of Notre Dame), Yenkai Huang (Dartmouth College): _LACE: Controlled Image Prompting and Iterative Refinement with GenAI for Professional Visual Art Creators_ [[pdf]](https://github.com/GenerativeAIandHCI/GenerativeAIandHCI.github.io/blob/main/papers/2025/17%20LACE___workshop__GenAICHI_%20(7).pdf)
3. Kazuki Kawamura (The University of Tokyo), Jun Rekimoto (SonyCSL): _SakugaFlow: A Stagewise Illustration Framework Emulating the Human Drawing Process and Providing Interactive Tutoring for Novice Drawing Skills_ [[pdf]](https://github.com/GenerativeAIandHCI/GenerativeAIandHCI.github.io/blob/main/papers/2025/27%20GenAICHI2025.pdf)
4. Kay Jingyan Zeng (Splunk), Zifan Zhang (Cherry Technologies), Huiran Yi (University of Michigan), Lu Xian (University of Michigan): _Understanding Designers’ Perceptions of the Usefulness of Generative AI Tools in Creative Design Processes_ [[pdf]](https://github.com/GenerativeAIandHCI/GenerativeAIandHCI.github.io/blob/main/papers/2025/36%20genai_creativity_chi25_workshop.pdf)
...
Discussion led by the organisers and participants.

## Lunch (12:40--14:10)

Lunch break (not provided at the venue).

## Session 5: Role of AI - Tool or Partner? (14:10--14:40)

1. Ilya Zakharov (JetBrains), Ekaterina Koshchenko (JetBrains), Agnia Sergeyuk (JetBrains): _From Teacher to Colleague: How Coding Experience Shapes Developer Perceptions of AI Tools_ [[pdf]](https://github.com/GenerativeAIandHCI/GenerativeAIandHCI.github.io/blob/main/papers/2025/20%20GenAICHI___Roles_of_AI.pdf)
2. Rendi Chevi (MBZUAI), Alham Aji (MBZUAI), Thamar Solorio (MBZUAI), Kentaro Inui (MBZUAI): _How Individual Traits and Language Styles Shape Preferences In Open-ended User-LLM Interaction_ [[pdf]](https://github.com/GenerativeAIandHCI/GenerativeAIandHCI.github.io/blob/main/papers/2025/39%20Style_Preference___GenAICHI_2025___v1_25.pdf)
3. Jaehoo Bae (Seoul National University), Jane Lee (Seoul National University), Eunseo Ryu (Seoul National University), Honghua Lyu (Seoul National University), Dain Kim (Seoul National University), Myung Hwan Yun (Seoul National University): _When Do Humans See AI as Humanlike? The Role of Perceived Performance in AI Anthropomorphism_ [[pdf]](https://github.com/GenerativeAIandHCI/GenerativeAIandHCI.github.io/blob/main/papers/2025/42%20When%20Do%20Humans%20See%20AI%20as%20Humanlike%20The%20Role%20of%20Perceived%20Performance%20in%20AI%20Anthropomorphism.pdf)

## Session 6: Applications (14:40--15:10)

1. Hirokazu Miyachi (Sekisuihouse Ltd), Naoko Yano (Sekisuihouse Ltd.), Momoyo Yadani (Sekisuihouse Ltd.), Yuya Hasegawa (Sekisuihouse Ltd.), Takahiro Suezawa (Sekisuihouse Ltd.), Akiko Taniguchi (Sekisuihouse Ltd.), Yumiko Ikeda (Sekisuihouse Ltd.), Issei Watanabe (Sekisuihouse Ltd.), Takahiro Yokoi (Sekisuihouse Ltd.), Yousuke Motohashi (NEC Corporation), Junichi Nakano (NEC Corporation ), Tomoki Tanaka (NEC Corporation), Miki Tanaka (NEC Corporation): _A Case Study of the Development of a Sensitivity-Based Interactive House Design Assistance System Using Generative AI_ [[pdf]](https://github.com/GenerativeAIandHCI/GenerativeAIandHCI.github.io/blob/main/papers/2025/%2015%202025_GENAICHI_Interactive_House_Design_Assistance_System_v6.pdf)
2. Rana Talukdar (Vellore Institute Of Technology, Bhopal), Bindupautra Jyotibrat (VIT Bhopal), Arunim Gogoi (VIT Bhopal), Ankur Jain (VIT Bhopal): _A State-of-Art Survey on Generative AI Techniques for Floor Planning_ [[pdf]](https://github.com/GenerativeAIandHCI/GenerativeAIandHCI.github.io/blob/main/papers/2025/06%20A_state_of_art_survey_on_generative_AI_techniques_for_floor_planning__1_%20(8).pdf)
3. Sunil Sharma (Capital One): _Leveraging Generative Adversarial Networks for Unsupervised Fraud Detection_ [[pdf]](https://github.com/GenerativeAIandHCI/GenerativeAIandHCI.github.io/blob/main/papers/2025/23%20Leveraging_GAN_for_Unsupervised_Fraud_Detection.pdf)

## General Discussion (15:10--15:40)

Discussion led by the organisers and participants.

## Break (15:40--16:20)

Afternoon tea break. Light refreshments will be provided at the venue.

## Session 7: Applications - Education and Related  (16:20--16:50)

1. Roberto Theron (Universidad de Salamanca), Andrea Vázquez-Ingelmo (Universidad de Salamanca), Alicia García-Holgado (Universidad de Salamanca), Francisco José García-Peñalvo (Universidad de Salamanca), Nastaran Shoeibi (Universidad de Salamanca): _A Technology-Mediated Approach to Addressing Reading Diversity in German Classrooms_ [[pdf]](https://github.com/GenerativeAIandHCI/GenerativeAIandHCI.github.io/blob/main/papers/2025/41%20GENAICHI2025_Workshop__Expandora.pdf)
...
3. Valerie Chen (Carnegie Mellon University), Alan Zhu (Carnegie Mellon University), Sebastian Zhao (UC Berkeley), Hussein Mozannar (Microsoft Research), David Sontag (MIT), Ameet Talwalkar (Carnegie Mellon University): _Need Help? Designing Proactive AI Assistants for Programming_ [[pdf]](https://github.com/GenerativeAIandHCI/GenerativeAIandHCI.github.io/blob/main/papers/2025/30%20CHI_2025_Workshop__Proactive_chat_assistant.pdf)

## Session 8: Formal Approaches (16:50--17:20)

1. Mingyue Yuan (university of the new south wales): _A Case Study of Scalable Content Annotation Using Multi-LLM Consensus and Human Review_ [[pdf]](https://github.com/GenerativeAIandHCI/GenerativeAIandHCI.github.io/blob/main/papers/2025/28%20Labeldata_short__Copy_.pdf)
2. Elakkiya Daivam (Capital One): _Probabilistic Deep Learning for Energy Time Series Forecasting: A Comparative Study_ [[pdf]](https://github.com/GenerativeAIandHCI/GenerativeAIandHCI.github.io/blob/main/papers/2025/26%20Probabilistic%20Deep%20Learning.pdf)
...
- Dmitri Goldenberg (Booking.com), Yulia Goldenberg (Ben Gurion University): _Agent Experience: Nielsen's Usability Heuristics Analysis for GenAI Agents_ [[pdf]](https://github.com/GenerativeAIandHCI/GenerativeAIandHCI.github.io/blob/main/papers/2025/05%20chi___agents_experience.pdf)
- Farnaz Asrari (Indiana University), L. Jean Camp (Indiana University): _AI-Enhanced Thematic Analysis of COVID-19 Impact: Combining Human Expertise with Generative AI_ [[pdf]](https://github.com/GenerativeAIandHCI/GenerativeAIandHCI.github.io/blob/main/papers/2025/12%20AI_in_Qualitative_research.pdf)
...
- Zhuoran Huang (Northeastern University): _Designing an LLM AI-Powered Digital Storytelling Assistant for Inclusive and Authentic Health Narratives_ [[pdf]](https://github.com/GenerativeAIandHCI/GenerativeAIandHCI.github.io/blob/main/papers/2025/19%20Designing%20an%20LLM%20AI-Powered%20Digital%20Storytelling%20Assistant%20for%20Inclusive%20and%20Authentic%20Health%20Narratives.pdf)
...
- Nicholas Wang (Stellar Learning Technologies): _Leveraging Interactive Generative AI for Enhancing Intuitive Learning_ [[pdf]](https://github.com/GenerativeAIandHCI/GenerativeAIandHCI.github.io/blob/main/papers/2025/09%20Leveraging%20Interactive%20Generative%20AI%20for%20Enhancing%20Intuitive%20Learning.pdf)
...
## Remote Presentation and Viewing

- The remote platform for the conference is Zoom
- Zoom links have been distributed via email.
...
- Please make sure you **test screen sharing and your presentation** in Zoom before the workshop 😊
...
Submissions may be up to 4 pages long (references may appear on additional pages), following the [using the ACM Primary Article Template](https://www.acm.org/publications/proceedings-template).
